...
## Main Flow and components 

*   **Synthetic Data Generation**:  Pipeline to generate context-specific prompt-response pairs using high-performance APIs (Cerebras, Groq) or local models.
...
*   **Resumable & Streaming**: The generation pipeline works in streaming mode, allowing safe resumes after interruptions.
